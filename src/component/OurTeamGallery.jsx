...
const OurTeamGallery = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <div
        className="text-red-500 p-16 flex flex-col items-center text-center space-y-8 mt-44"
        style={{
          background:
            "linear-gradient(90deg, hsla(230, 100%, 12%, 1) 0%, hsla(230, 100%, 12%, 1) 0%, hsla(230, 100%, 10%, 1) 31%)",
        }}
        ...
        >
          <h1 className="text-3xl font-bold font-poppins">
            <span className="text-white">
              ...
              <span className="text-red-500"> OUR GALLERY</span> 
            </span>
          </h1>
      ...
      <div className="px-4 sm:px-8 lg:px-16 space-y-10">
        ...
        <div className="text-center my-16 sm:my-20 ">
          ...
          >
            ...
            <div
        className="text-red-500 p-16 flex flex-col items-center text-center space-y-8 mb-0 pb-0 mt-40"
        style={{
          background:
            "linear-gradient(90deg, hsla(230, 100%, 12%, 1) 0%, hsla(230, 100%, 12%, 1) 0%, hsla(230, 100%, 10%, 1) 31%)",
        }}
      >
        ...
        >
          ...
          <span className="text-white">
              VIEW ALL{" "}
              <span className="text-red-500"> COMPANIES</span> 
            </span>
          </h1>
        ...
        {/* Company Logos Marquee */}
        <div className="relative  py-48 mt-0 pt-0 overflow-hidden">
          <div className="marquee-container relative">
            <div className="marquee flex space-x-16 items-center">
              {companies.concat(companies).map((company, index) => (
                <div key={index} className="flex items-center px-4">
          ...
          {/* Gradient fade effect */}
          <div className="absolute top-0 left-0 w-32 h-full bg-gradient-to-r "></div>
          <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l "></div>
        </div>
      </div>
