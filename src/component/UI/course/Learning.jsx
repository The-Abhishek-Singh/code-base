...
//         <div className="bg-gradient-to-b from-red-950 to-black rounded-2xl p-8 mb-12 text-center border border-gray-800 shadow-xl shadow-red-900/10 relative">
//           {/* <div className="absolute h-[200px] w-[200px] top-0 left-1/2 rounded-full bg-[#e33232] blur-[100px] -translate-x-1/2" /> */}
...
//               >
//                 <div className="bg-gray-800/50 px-4 py-2 rounded-lg backdrop-blur-sm border border-gray-700/50 flex items-center justify-center">
//                   <Image
//                     src={brand.logo}
//                     alt={`${brand.name} logo`}
//                     width={100}
...
//             <Link
//               href="#"
//               className="inline-block px-6 py-3 bg-gradient-to-r from-red-700 to-red-500 text-white font-bold rounded-full hover:from-red-600 hover:to-red-400 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg shadow-red-600/30"
//             >
//               Enroll Now
//             </Link>
//           </div>
...
//               <div
//                 key={course.id}
//                 className="rounded-xl overflow-hidden transition-all duration-300 hover:-translate-y-2 group relative shadow-lg hover:shadow-red-900/20"
//                 style={{
