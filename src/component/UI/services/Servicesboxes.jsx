...
const Servicesboxes = ({ title, bgUrl, shifturl }) => {
  ...
  <div
    className='w-80 h-80 flex flex-col justify-center border-2 border-white rounded-2xl p-6 shadow-bg custom-width001 hover:scale-105 transition duration-300'
  ...
  >
    <div className='w-full h-auto flex flex-col align-bottom mt-auto items-center'>
      <div className='mt-auto flex flex-col items-center gap-10 w-auto'>
        <h1 className='font-extrabold sm:text-2xl text-left text-lg mb-5'>{title}</h1>
      </div>
