...
const ServiceCarousel = () => {
  ...
  return (
    <div className="bg-black  mt-4 2xl:pt-20 ">
        ...
        <div className="sm:text-left w-full flex flex-col justify-center text-center sm:block sm:w-1/2 mb-12">
          ...
          <div className=" hidden sm:flex items-center">
            <div className="relative h-24 w-32 overflow-hidden">
              ...
              <div>
                <Image src="/ServiceCarousel/rightArrow.svg" width={72} height={14.4} alt="right arrow" className='opacity-90 w-10 sm:w-12  md:w-[4.5rem] -mt-2 sm:-mt-3'/>
              </div>
            </div>
          </div>
        </div>
