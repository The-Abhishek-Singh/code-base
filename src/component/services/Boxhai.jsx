...
const head = () => {
  ...
  <div className='relative py-6 md:p-0'>
   <h1 className='text-white font-bold text-3xl md:text-4xl lg:text-5xl mb-7 inline-block'>OUR SERVICES</h1>
    <img src="/services/Removed.png" alt="Removed" className='float-right m-4 relative lg:-top-20 sm:w-[50%] md:w-[50%] lg:w-[500px] sm:block hidden'/>
