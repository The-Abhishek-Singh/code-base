...
export default function Home(){
  ...
  const courseData = [
    ...
    },
    {
      ...
      modules: [
        ...
        "Why Git for your organization, how to Install Git",
    ...
    },
    {
      ...
      modules: [
        ...
        "Git workflows & Git cheatsheet",
        "What is CI, Why CI is Required?",
        "Introduction to Jenkin & Maven",
      ]
    },
    {
    ...
    },
    {
      ...
      modules: [
        ...
        "K8SArchitecture, Installation of K8S",
        "Understanding YAML",
        "HELM chart"
      ],
    },
    {
      ...
      modules: [
        "Introduction to Ansible, Basics&Installation, Ansible Architecture",
        "Control Machine Requirements,  Node Machine Requirements",
    ...
    },
    {
      ...
      modules: [
        "Introduction to Continuous Monitoring & Nagios & ELK",
  ...
  <>
      ...
      <div className="frame1 h-auto w-full flex flex-col lg:flex-row bg-black">
        ...
        <Heading text="AWS DEVOPS" color='white' bgColor='black'/>
      </div>
        <p className="text-lg pl-[1rem] md:text-md text-white">AWS (Amazon Web Services) is one of the leading cloud platforms that supports DevOps practices, providing a suite of tools and services to automate and optimize the entire software development and deployment pipeline. An AWS DevOps course typically prepares professionals to utilize AWS services and best practices for implementing and managing DevOps workflows, from continuous integration and continuous deployment (CI/CD) to monitoring, logging, and infrastructure as code (IaC).</p>
          <ul className="p-3 lg:p-5 list-disc">
            ...
            <li className="ls-img text-white text-xl md:text-base">
              <p>Collaborate effectively in a team environment.</p>
            </li>
            <li className="ls-img text-white text-xl md:text-base">
              <p>Apply theoretical knowledge to practical projects.</p>
            </li>
      ...
      <div className="p-6 flex justify-center">
        ...
        <ul className="w-full text-black grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-y-[2rem] md:gap-x-20 p-4 md:p-[5%] mb-5 list-disc">
          {/* Skills list items */}
          <li>
            <p className="text-xl xl:text-2xl">Overview of DevOps</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Continuous Monitoring with Nagios & ELK</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Version Control with Git</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Introduction to DevOps on Cloud</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Git, Jenkins & Maven Integration</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Containerization using Kubernetes</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Continuous Integration using Jenkins</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Configuration Management With Ansible</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Continuous Deployment: Containerization with Docker</p>
          </li>
        </ul>
      ...
      <div className="mb-9">
        <Heading text="AWS DEVOPS COURSE CURRICULUM" color='black' bgColor='white'/>
      </div>
      ...
      <div className="mb-2 p-4">
        <Heading text="AWS DEVOPS CERTIFICATE FAQs" color='black' bgColor='white'/>
      </div>
