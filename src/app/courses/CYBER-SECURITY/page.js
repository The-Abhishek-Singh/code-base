...
export default function Home(){
  ...
  <>
      ...
      <div className="frame1 h-auto w-full flex flex-col lg:flex-row bg-black">
        ...
        <Heading text="CYBER SECURITY, ETHICAL HACKING & INFORMATION SECURITY" color='white' bgColor='black'/>
      </div>
        <p className="text-lg pl-[1rem] md:text-md text-white">Cyber threats are becoming increasingly sophisticated, understanding how to defend against them is critical. Whether you're looking to protect sensitive data, conduct ethical hacking, or manage an organization's information security, our Cyber Security, Ethical Hacking, and Information Security training program offers a holistic approach to securing digital infrastructures. Learn to identify vulnerabilities, conduct penetration tests, and implement risk management strategies—all while adhering to industry best practices.</p>
          <ul className="p-3 lg:p-5 list-disc">
            ...
            <li className="ls-img text-white text-xl md:text-base">
              <p>Gain mastery over essential security tools and techniques.</p>
            </li>
            <li className="ls-img text-white text-xl md:text-base">
              <p>30–40 hours of practical, real-world experience through labs and simulations.</p>
            </li>
      ...
      <div className="p-6 flex justify-center">
        ...
        <ul className="w-full text-black grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-y-[2rem] md:gap-x-20 p-4 md:p-[5%] mb-5 list-disc">
          ...
          <li>
            <p className="text-xl xl:text-2xl">Information Gathering & Footprinting</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Trace Covering</p>
          </li>
          <li>
            <p className="text-xl xl:text-2xl">Enumeration & Vulnerability Analysis</p>
          </li>
          <li>
          ...
          <li>
            <p className="text-xl xl:text-2xl">Industry scenario on Pentesting</p>
          </li>
          <li>
      ...
      <div className="mb-9">
        <Heading text="CYBER SECURITY, ETHICAL HACKING & INFORMATION SECURITY COURSE CURRICULUM" color='black' bgColor='white'/>
      </div>
      ...
      <div className="mb-2 p-4">
        <Heading text="CYBER SECURITY, ETHICAL HACKING & INFORMATION SECURITY
 CERTIFICATE FAQs" color='black' bgColor='white'/>
      </div>
