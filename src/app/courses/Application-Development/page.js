...
export default function LiveLearningPage() {
       ...
       <div className="min-h-screen bg-black text-white p-6 md:p-12">
         <div className="container mx-auto max-w-7xl">
             ...
             <div className="grid md:grid-cols-3 gap-4">
               ...
               <div className="relative bg-gray-900 rounded-xl overflow-hidden h-52">
                 <div
                   ...
                   style={{ backgroundImage: "url('/newco/co2.png')" }}
                 ></div>
           ...
           <div className="bg-black text-white p-6 md:p-12">
             ...
             <div className="grid grid-cols-4 grid-rows-6 gap-2 h-[550px]">
               ...
               <div className="row-span-2 col-start-1 row-start-5 bg-black text-white rounded-lg border border-white border-opacity-20 hover:border-opacity-50 transition-all duration-300 relative h-full overflow-hidden">
                 <div className="absolute inset-0 z-0">
                   <img
                     src="\newco\soln.avif"
               ...
               {/* Live Classroom */}
               <div className="col-span-2 row-span-4 col-start-2 row-start-1 bg-black text-white rounded-lg border border-white border-opacity-20 hover:border-opacity-50 transition-all duration-300 relative h-full overflow-hidden">
                 <div className="absolute inset-0 z-0">
                   <img
                     src="\newco\cou9.png"
                     alt="Live Classroom"
               ...
               {/* Cloud Sandbox */}
               <div className="col-span-2 row-span-2 col-start-2 row-start-5 bg-black text-white rounded-lg border border-white border-opacity-20 hover:border-opacity-50 transition-all duration-300 relative h-full overflow-hidden">
                 <div className="absolute inset-0 z-0">
                   <img
                     src="\newco\cloud.jpg"
                     alt="cloud"
               ...
               <div className="row-span-3 col-start-4 row-start-1 bg-black text-white rounded-lg border border-white border-opacity-20 hover:border-opacity-50 transition-all duration-300 relative h-full overflow-hidden">
                 <div className="absolute inset-0 z-0">
                   <img
                     src="\newco\ai.avif"
                     alt="AI Assistance"
               ...
               {/* Teaching Assistance */}
               <div className="row-span-3 col-start-4 row-start-4 bg-black text-white rounded-lg border border-white border-opacity-20 hover:border-opacity-50 transition-all duration-300 relative h-full overflow-hidden">
                 <div className="absolute inset-0 z-0">
                   <img
                     src="\newco\course3.png"
                     alt="teaching"
   ...
   <div 
     ...
     style={{ backgroundImage: "url('/newco/test.webp')" }}  Set your image path
   >
           ...
           <div className="container mx-auto max-w-7xl">
             ...
             <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
               ...
               {[
                 {
                   name: "Anshuman Singh",
                   role: "Founder at Scalar, ex - Meta",
                 },
                 ...
                 .map((_, index) => (
                   ...
                   >
                     ...
                     <p className="text-gray-400">
                       The training was awesome. The instructor has done a great
                       job. He was very patient throughout the sessions and took
                       additional time to explain the concepts further when we
                       had queries.
                     </p>
                   </div>
                 ))}
...
//                 </div>
//             </div>
//             <div className='min-h-auto w-[85%] rounded-lg px-5 py-3 bg-[#fff] absolute bottom-0 translate-y-1/2 left-1/2 -translate-x-1/2 flex justify-between z-10'>
//                 <div className='flex w-full text-black gap-5 flex-wrap'>
//                    <div className='h-full w-1/4 px-3 flex flex-col shrink-0 justify-around'>
//                     <div className='h-1/4'><p className='text-lg'>Propgram Duration</p></div>
//                     <div className='h-3/4 border-r-4 flex items-center'><p className='font-bold text-2xl'><span className='text-3xl'>12</span> Months</p></div>
//                    </div> 
//                    <div className='h-full w-1/4 px-3 flex flex-col shrink-0 justify-around'>
//                    <div className='h-1/4'><p className='text-lg'>Time Commitment</p></div>
//                    <div className='h-3/4 border-r-4 flex items-center'><p className='font-bold text-2xl'>12-15 Hrs/Week</p></div>
//                    </div> 
//                    <div className='h-full w-1/4 px-3 flex flex-col shrink-0 justify-around'>
//                    <div className='h-1/4'><p className='text-lg'>Placement Support</p></div>
//                    <div className='h-3/4 border-r-4 flex items-center'><p className='font-bold text-2xl'>900+ Companies</p></div>
//                    </div> 
//                    <div className='h-full w-1/4 px-3 flex flex-col shrink-0 justify-around'>
//                    <div className='h-1/4'><p className='text-lg'>Enrollment</p></div>
