  ...
  const services = [
    {
      ...
      description: "Custom software development, web applications, mobile apps, and full-stack development from expert teams at competitive rates.",
      icon: <Code className="h-10 w-10 text-red-500" />
    },
    {
      title: "Data Processing & Analytics",
      description: "Advanced data entry, processing, analysis, and visualization services to transform your raw data into actionable business insights.",
      icon: <Database className="h-10 w-10 text-red-500" />
    },
    {
      title: "Customer Support",
      description: "24/7 multichannel customer service solutions including phone, email, chat, and social media support in multiple languages.",
      icon: <Headphones className="h-10 w-10 text-red-500" />
    },
    {
      title: "Back Office Operations",
      description: "Streamline administrative tasks with our efficient back-office support including accounting, HR, and procurement services.",
      icon: <FileText className="h-10 w-10 text-red-500" />
    },
    {
      title: "Business Process Outsourcing",
      description: "End-to-end business process management solutions customized to optimize efficiency and reduce operational costs.",
      icon: <PieChart className="h-10 w-10 text-red-500" />
    },
    {
      title: "Custom Solutions",
      description: "Tailored outsourcing strategies designed specifically for your business needs, industry requirements, and growth objectives.",
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-32 relative z-10">
          <div className={`transform transition-all duration-1000 delay-300 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-2xl text-gray-300 transform transition-all duration-1000 delay-500" 
              ...
              Optimize operations, reduce costs, and scale your business with our comprehensive outsourcing services tailored to your strategic objectives.
            </p>
      ...
      <div ref={servicesRef} className="container mx-auto px-4 py-24 observe-section">
        <div className="text-center mb-16">
          <h2 className={`text-3xl md:text-4xl font-bold mb-4 relative inline-block ${isVisible ? 'opacity-100' : 'opacity-0'} transition-opacity duration-1000`}>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400 animate-gradient-x">Our Outsourcing Services</span>
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto transform transition-all duration-1000 delay-700"
             style={{ opacity: isVisible ? 1 : 0, transform: isVisible ? 'translateY(0)' : 'translateY(20px)' }}>
            Comprehensive business solutions designed to enhance efficiency, quality, and profitability across your operations.
          </p>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 transform transition-all duration-1000" 
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              A proven methodology designed to seamlessly integrate our outsourcing solutions with your existing business operations.
            </p>
          </div>
      ...
      <div ref={whyUsRef} className="container mx-auto px-4 py-24 observe-section">
        <div className="text-center mb-16 transform transition-all duration-1000" 
             style={{ opacity: isVisible ? 1 : 0, transform: isVisible ? 'translateY(0)' : 'translateY(20px)' }}>
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400 animate-gradient-x">Why Choose Our Outsourcing</h2>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Partner with us for comprehensive outsourcing solutions that drive business growth and operational excellence.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-900 p-8 rounded-lg transition-all duration-500 hover:bg-gray-800 border border-gray-800 hover:border-red-500 group relative overflow-hidden transform hover:-translate-y-2">
            ...
            <ul className="space-y-4 text-gray-300">
              {["Experienced teams with industry-specific expertise", "Robust quality management and reporting systems", "Scalable services that grow with your business needs"].map((item, i) => (
          ...
          <div className="bg-gray-900 p-8 rounded-lg transition-all duration-500 hover:bg-gray-800 border border-gray-800 hover:border-red-500 group relative overflow-hidden transform hover:-translate-y-2">
            ...
            <ul className="space-y-4 text-gray-300">
              {["Significant cost reduction while maintaining quality", "Access to specialized skills and technologies", "Focus on core business functions while we handle operations"].map((item, i) => (
                <li key={i} className="flex items-start transform transition-all duration-500 hover:translate-x-2 relative pl-6">
                  <span className="absolute left-0 top-0 text-red-500 font-bold transition-all duration-300 group-hover:text-red-400">✓</span>
                  <span className="relative">
                    {item}
      ...
      <div className="py-24 relative overflow-hidden observe-section">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-br from-white to-gray-400 animate-gradient-x">Transform Your Business Operations</h2>
