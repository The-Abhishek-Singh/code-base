...
const Robocourse = () => {
  ...
  return (
    <div className='mb-0 px-5 sm:px-10 lg:mb-11 xl:mb-44 lg:p-0 mt-[7%] sm:mt-0'>
      <div className='h-[50vh] lg:h-screen w-full bg-black flex relative md:mt-0 lg:mt-[-4%] flex-col justify-center min-h-[90vh-6rem]'>
        {/* CONTENT DIV */}
        <div className='md:min-w-[40rem] sm:mt-[-10vh] md:ml-[4%] xl:ml-[5%] md:mt-[5%] lg:mt-[6%] z-0'>
          <h1 className='lg:text-[1.45rem] text-3xl font-extrabold tracking-wide my-[2rem] text-red-500 '>
            Elevate Your Career, Elevate Your Business <br />
          </h1>
          <p className='font-semibold lg:max-w-[33rem] lg:text-lg xl:text-xl text-gray-400'>
        ...
        {/* 3D MODEL VIEWER */}
        <div className='absolute top-0 right-0 w-[100%] lg:mt-0 lg:w-[99%] lg:scale-[0.7] lg:right-[-20%] xl:w-[80%] xl:scale-100 xl:right-[-9%] xl:mt-[5vh] 2xl:w-[70%] h-full flex items-center justify-center z-0 opacity-100'>
