...
const Hero = () => {
  ...
  const loaderDelay = 500; // 4 seconds for your loader
  ...
  const modelTransform = `translateY(${scrollPosition * 0.15}px)`;
  ...
  return (
    <div className='mb-36 px-6 md:px-10 lg:p-0'>
      ...
      >
        ...
        {/* 3D MODEL VIEWER */}
        <div 
          className='absolute -top-16 right-0 w-[100%] lg:-mt-16 lg:w-[99%] lg:scale-[0.5] md:scale-[0.4] md:right-[-30%] lg:right-[-24%] xl:w-[80%] xl:scale-[0.6] xl:right-[-15%] xl:mt-[-4vh] 2xl:w-[70%] 2xl:scale-[0.7] 2xl:right-[-8%] 2xl:top-[-5%] h-full flex items-center justify-center opacity-100'
